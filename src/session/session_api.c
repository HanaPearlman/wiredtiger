  ...
  WT_SESSION_IMPL **sessionp)
{
    static const WT_SESSION
      stds = {NULL, NULL, __session_close, __session_reconfigure, __wt_session_strerror,
        ...
        __session_log_printf, __session_range_selectivity, __session_rename, __session_reset,
        __session_salvage, __session_truncate, __session_verify, __session_begin_transaction,
      ...
      stds_min = {NULL, NULL, __session_close, __session_reconfigure_notsup, __wt_session_strerror,
        ...
        __session_range_selectivity, __session_rename_readonly, __session_reset_notsup,
      ...
      stds_readonly = {NULL, NULL, __session_close, __session_reconfigure, __wt_session_strerror,
        ...
        __session_range_selectivity, __session_rename_readonly, __session_reset,
