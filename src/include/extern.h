...
extern int __wt_btcur_prev(WT_CURSOR_BTREE *cbt, bool truncating)
  WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
extern int __wt_btcur_range_selectivity(WT_CURSOR *start, WT_CURSOR *stop, double baseCard,
  double *selectivityp) WT_GCC_FUNC_DECL_ATTRIBUTE((warn_unused_result));
