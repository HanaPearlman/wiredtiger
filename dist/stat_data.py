...
conn_stats = [
    ...
    CursorStat('cursor_range_selectivity', 'cursor range_selectivity calls'),
    ...
    SessionOpStat('session_table_range_selectivity_fail', 'table range_selectivity failed calls', 'no_clear,no_scale'),
    SessionOpStat('session_table_range_selectivity_success', 'table range_selectivity successful calls', 'no_clear,no_scale'),
